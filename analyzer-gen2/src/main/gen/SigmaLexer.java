...
public class SigmaLexer extends Lexer {
	...
	public static final int
		LeftBrace=1, RightBrace=2, Dash=3, Colon=4, Comma=5, IntLiteral=6, Whitespace=7;
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"LeftBrace", "RightBrace", "Dash", "Colon", "Comma", "IntLiteral", "Whitespace"
		};
	}
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			null, "LeftBrace", "RightBrace", "Dash", "Colon", "Comma", "IntLiteral", 
			"Whitespace"
		};
	}
