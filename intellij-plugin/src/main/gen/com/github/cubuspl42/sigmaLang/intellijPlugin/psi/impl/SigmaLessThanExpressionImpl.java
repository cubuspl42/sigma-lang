...
public class SigmaLessThanExpressionImpl extends SigmaUnimplementedExpressionImplMixin implements SigmaLessThanExpression {

  public SigmaLessThanExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }
