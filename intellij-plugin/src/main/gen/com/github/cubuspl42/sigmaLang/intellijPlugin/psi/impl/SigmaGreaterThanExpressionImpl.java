...
public class SigmaGreaterThanExpressionImpl extends SigmaUnimplementedExpressionImplMixin implements SigmaGreaterThanExpression {

  public SigmaGreaterThanExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }
