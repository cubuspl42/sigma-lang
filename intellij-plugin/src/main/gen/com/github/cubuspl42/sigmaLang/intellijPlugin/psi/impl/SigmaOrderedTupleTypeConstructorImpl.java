...
public class SigmaOrderedTupleTypeConstructorImpl extends ASTWrapperPsiElement implements SigmaOrderedTupleTypeConstructor {
  ...
  public void accept(@NotNull SigmaVisitor visitor) {
    visitor.visitOrderedTupleTypeConstructor(this);
  }
  ...
  @Override
  @NotNull
  public List<SigmaOrderedTupleTypeConstructorEntry> getOrderedTupleTypeConstructorEntryList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, SigmaOrderedTupleTypeConstructorEntry.class);
  }
