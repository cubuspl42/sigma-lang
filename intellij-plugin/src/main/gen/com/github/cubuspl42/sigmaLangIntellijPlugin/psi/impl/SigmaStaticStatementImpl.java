...
public class SigmaStaticStatementImpl extends ASTWrapperPsiElement implements SigmaStaticStatement {
  ...
  @Override
  @Nullable
  public SigmaConstantDefinition getConstantDefinition() {
    return findChildByClass(SigmaConstantDefinition.class);
  }

  @Override
  @Nullable
  public SigmaNamespaceDefinition getNamespaceDefinition() {
    return findChildByClass(SigmaNamespaceDefinition.class);
  }
