...
public class SigmaAdditionExpressionImpl extends SigmaBinaryExpressionImplMixin implements SigmaAdditionExpression {

  public SigmaAdditionExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }
