...
public class SigmaCompactTermImpl extends SigmaTermImpl implements SigmaCompactTerm {

  public SigmaCompactTermImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull SigmaVisitor visitor) {
    visitor.visitCompactTerm(this);
  }
