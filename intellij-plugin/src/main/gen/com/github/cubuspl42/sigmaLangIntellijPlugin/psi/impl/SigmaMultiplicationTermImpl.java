...
public class SigmaMultiplicationTermImpl extends SigmaTermImpl implements SigmaMultiplicationTerm {

  public SigmaMultiplicationTermImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull SigmaVisitor visitor) {
    visitor.visitMultiplicationTerm(this);
  }
