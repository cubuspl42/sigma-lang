...
public class SigmaLetExpressionScopeImpl extends ASTWrapperPsiElement implements SigmaLetExpressionScope {

  public SigmaLetExpressionScopeImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SigmaVisitor visitor) {
    visitor.visitLetExpressionScope(this);
  }
