...
public class SigmaParenCompactExpressionImpl extends SigmaCompactExpressionImpl implements SigmaParenCompactExpression {

  public SigmaParenCompactExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull SigmaVisitor visitor) {
    visitor.visitParenCompactExpression(this);
  }
